...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='MPT',
                             help='see lib/dataset/dataset_facotry for ' + 
                            'available datasets')
    self.parser.add_argument('--test_dataset', default='MPT',
  ...
  def init(self, args=''):
    default_dataset_info = {
        'ctdet': {'default_resolution': [1024, 750], 'num_classes': 27,
                  'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                  'dataset': 'MPT'},
        'multi_pose': {'default_resolution': [1024, 750], 'num_classes': 27,
                'mean': [1.816706, 1.856168, 1.751525], 'std': [2.632229, 2.685731, 2.541777],
                'dataset': 'MPT'},
        'ddd': {'default_resolution': [1024, 750], 'num_classes': 27,
                'mean': [1.816706, 1.856168, 1.751525], 'std': [2.632229, 2.685731, 2.541777],
                'dataset': 'MPT'},
        'tracking,ctdet': {'default_resolution': [1024, 750], 'num_classes': 27,
                  'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                  'dataset': 'MPT'},
        'tracking,multi_pose': {'default_resolution': [1024, 750], 'num_classes': 27,
                'mean': [1.816706, 1.856168, 1.751525], 'std': [2.632229, 2.685731, 2.541777],
                'dataset': 'MPT'},
        'tracking,ddd': {'default_resolution': [1024, 750], 'num_classes': 27,
                'mean': [1.816706, 1.856168, 1.751525], 'std': [2.632229, 2.685731, 2.541777],
                'dataset': 'MPT'}
    }
    opt = self.parse()
