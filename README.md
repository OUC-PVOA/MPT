...
##### The MPT dataset can be downloaded from the following link: [[baidu(code:t29b)]](https://pan.baidu.com/s/1frgxo2Vl8JirpLJTvbs9lQ)
...
### Run Demo
The model weights are placed in the same link as the MPT dataset: [[baidu(code:t29b)]](https://pan.baidu.com/s/1frgxo2Vl8JirpLJTvbs9lQ). Then, cd `DSFT_ROOT/src/`. The demo result will be saved as a video in `DSFT_ROOT/results/`.
